...
import { Brain, Mail, Lock, AlertCircle, Loader2, GraduationCap, Shield } from 'lucide-react';
        ...
        <div className="bg-background rounded-2xl shadow-xl border border-border p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 mb-4">
              {isAdmin ? <Shield className="w-8 h-8 text-white" /> : <GraduationCap className="w-8 h-8 text-white" />}
            </div>
            <h1 className="text-2xl font-bold mb-2">
              {isAdmin ? 'Admin Login' : 'Student Login'}
            </h1>
            <p className="text-muted-foreground">
              {isAdmin ? 'Access the admin dashboard' : 'Welcome back! Sign in to continue learning'}
            </p>
          </div>
          ...
          {!isAdmin && (
            <>
              ...
              <button
                ...
                className="w-full py-3 border-2 border-border rounded-lg font-medium hover:bg-accent transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
                {googleLoading ? (
                  <>
                    <Loader2 className="w-5 h-5 animate-spin" />
